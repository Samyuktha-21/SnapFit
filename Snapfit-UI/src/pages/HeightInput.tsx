...
export default function HeightInput() {
  const { height, setHeight } = useMeasurementStore();
  ...
  return (
    <div className="min-h-[85vh] flex flex-col items-center justify-start py-8 px-4 md:px-6">
      ...
      <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-8 items-center mt-8">
        ...
        <div className="flex flex-col items-center justify-center rounded-3xl border border-neutral-800 bg-neutral-900/40 p-8 h-[360px] md:h-[450px] relative overflow-hidden shadow-[0_0_30px_rgba(255,255,255,0.05)]">
          <div className="absolute top-[10%] left-[20%] h-32 w-32 rounded-full bg-white/5 blur-2xl pointer-events-none" />
          
          {/* Vertical Ruler Lines */}
          <div className="absolute left-6 top-6 bottom-6 w-3 border-r border-neutral-800/80 flex flex-col justify-between text-[10px] text-neutral-600 font-mono">
            <span>220cm</span>
            <span>200cm</span>
            <span>180cm</span>
            <span>160cm</span>
          ...
          >
            <div className="h-16 w-16 rounded-full bg-neutral-900 border border-neutral-700 flex items-center justify-center text-white mb-2 shadow">
              <User className="h-8 w-8" />
            </div>
            
            {/* Standing rectangular vector block */}
            <div className="w-20 h-44 rounded-2xl bg-gradient-to-t from-neutral-800 to-neutral-600 shadow-lg opacity-85" />
          </motion.div>
        ...
        <div className="rounded-3xl border border-neutral-800 bg-black p-6 md:p-8 shadow-[0_0_30px_rgba(255,255,255,0.05)] flex flex-col justify-between h-[360px] md:h-[450px]">
          <div>
            <div className="inline-flex items-center gap-1.5 rounded-full bg-white/10 border border-white/20 px-3 py-1 text-xs font-semibold text-white mb-4">
            ...
            <div className="flex items-baseline justify-center gap-1 my-10 text-center">
              ...
              <span className="text-xl font-bold text-neutral-500">cm</span>
            </div>
            ...
            <div className="relative px-2">
              <input
                ...
                className="w-full h-1.5 bg-neutral-900 rounded-lg appearance-none cursor-pointer accent-white focus:outline-none"
              />
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-1.5 rounded-xl bg-white hover:bg-neutral-200 text-black font-bold text-sm py-4 shadow-lg shadow-white/10 hover:shadow-white/20 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 cursor-pointer"
          >
